...
export const deviceTypes = [
  { label: "TV", value: "1" },
  { label: "Smart Phone", value: "2" },
  { label: "Smart Tablet", value: "3" },
  { label: "Personal Computer", value: "4" },
  { label: "Laptop", value: "5" },
];
export const tableOptions = [
  { label: "-", value: "1" },
  { label: "Browsing", value: "2" },
  { label: "Emailing", value: "3" },
  { label: "Music", value: "4" },
  { label: "Social Media", value: "5" },
  { label: "Gaming", value: "6" },
  { label: "Navigation", value: "7" },
  { label: "Education SD", value: "8" },
  { label: "Education HD", value: "9" },
  { label: "Video Meetings SD", value: "10" },
  { label: "Video Meetings HD", value: "11" },
...
// 8 Education SD
// 9 Education HD
// 10 Video Meetings SD
// 11 Video Meetings HD
// 12 Video Streaming SD
